...
```bash
shared/scripts/mineru_to_md.sh <paper.pdf> --output <output-dir>
```
...
```bash
MINERU_TO_MD=/path/to/mineru_to_md.sh python shared/scripts/extract_pdf.py paper.pdf --output out --prefer-mineru
```
